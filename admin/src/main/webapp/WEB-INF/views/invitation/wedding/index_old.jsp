                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form id="weddingForm" data-toggle="validator" role="form" method="post" action="/api/wedding">
                                ...
                                <tr>
                                    ...
                                    <td class="row">
                                        <div class="input-group col-sm-6">
                                            <input class="form-control country" name="country" type="text" value="${wedding.country}" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="row">
                                        <div class="input-group col-sm-6">
                                            <input class="form-control city" name="city" type="text" value="${wedding.city}" required>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <div class="breadcrumbs">
                                <div class="clearfix align-right">
                                    <button type="button" id="btn_add_gift" class="btn btn-info btn-sm">Gift 추가</button>
                                </div>
                            </div>
                            <table class="table table-striped table-bordered table-hover">
                                <thead>
                                <tr>
                                    ...
                                    <th class="center" width="15%">가격</th>
                                    <th class="center" width="5%"></th>
                                </tr>
                                </thead>

                                <tbody id="gift_item_area">

                                <c:forEach var="gift" items="${wedding.gifts}">
                                    <tr class="gift_item">
                                        <td>
                                                ${gift.id}
                                            <input class="form-control gift_id" name="giftId" type="hidden" value="${gift.id}" required>
                                        </td>
                                        <td>
                                            <input class="form-control gift_name" name="giftName" type="text" value="${gift.name}" required>
                                        </td>
                                        <td>
                                            받고 싶은 선물을 등록하세요
                                        </td>

                                        <td class="row gift_image_area">
                                            <div class="slim"
                                                 data-service="/api/file/image"
                                                 data-did-upload="attachGiftImage"
                                                 data-did-remove="removeGiftImage"
                                                 data-size="1920,1080"
                                            >
                                                <c:if test="${not empty gift.imageUrl}">
                                                    <img src="${gift.imageUrl}" >
                                                </c:if>
                                                <input type="file" name="image" />
                                            </div>
                                            <input class="gift_image_url" type="hidden" name="giftImageUrl" value="${gift.imageUrl}">
                                        </td>


                                        <td>
                                            <input class="form-control gift_price" name="giftPrice" type="text" value="${gift.price}" required>

                                        </td>
                                        <td>
                                            <button type="button" class="btn btn_delete_gift btn-sm">삭제</button>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<content tag="local_script">
    ...
    <script src="/${buildTimestamp}/resources/js/gift/Gift.js"></script>
    ...
    <script type="text/javascript">
        ...
        function attachGiftImage(error , data , response) {
            if (error == null)
                $(this._originalElement).parent().find('.gift_image_url').val(response.path);
        }

        function removeGiftImage(data) {
            $(this._originalElement).parent().find('.gift_image_url').val('');
        }
        ...
        $(document).on('click' , '.btn_delete_gift' , function() {
            $(this).parents('tr').remove();
        });
        ...
        $('#btn_add_gift').on('click', function () {

            var source = $('#gift_item_template').html();
            var template = Handlebars.compile(source);
            var $html = $(template(null));
            Slim.parse($html[0]);
            $('#gift_item_area').prepend($html);
...
<script id="gift_item_template" type="text/x-handlebars-template">
    <tr class="gift_item">
        <td>
            <input class="form-control gift_id" name="giftId" type="hidden" value="0" required>
        </td>
        <td>
            <input class="form-control gift_name" name="giftName" type="text" value="" required>
        </td>
        <td>
            받고 싶은 선물을 등록하세요
        </td>
        <td class="row gift_image_area">
            ...
            <input class="gift_image_url" type="hidden" name="giftImageUrl">
        </td>


        <td>
            <input class="form-control gift_price" name="giftPrice" type="text" value="" required>
        </td>
        <td>
            <button type="button" class="btn btn_delete_gift btn-sm">삭제</button>
        </td>
