package com.seolgi.wedding.invitation;
...
@PropertySource(value = "classpath:properties/application-${spring.profiles.active}.invitation.properties")
@Import(CoreApplication.class)
public class InvitationApplication extends SpringBootServletInitializer {
