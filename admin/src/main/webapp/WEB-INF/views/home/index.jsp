            ...
            <div class="slider-banner-fullwidth-big-height">
                <ul class="slides">
                    ...
                    <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="500" data-saveperformance="on" data-title="Next Generation Template">
                        ...
                        <!-- main image -->
                        <img src="/resources/lib/bootstrap/html/template/images/corporate-2-slider-slide-1.jpg" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
                    ...
                    <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="500" data-saveperformance="on" data-title="Premium Bootstrap Template">
                        ...
                        <!-- main image -->
                        <img src="/resources/lib/bootstrap/html/template/images/corporate-2-slider-slide-2.jpg" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover">
        ...
        <div class="row grid-space-10">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <div class="overlay-container">
                                    <img src="/resources/lib/bootstrap/html/template/images/portfolio-1.jpg" alt="">
                            ...
                            <div class="item">
                                <div class="overlay-container">
                                    <img src="/resources/lib/bootstrap/html/template/images/portfolio-1-2.jpg" alt="">
                                    <div class="overlay-to-top">
                                        <p class="small margin-clear"><em>Web design <br> Lorem ipsum dolor sit</em></p>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div class="overlay-container">
                                    <img src="/resources/lib/bootstrap/html/template/images/portfolio-1-3.jpg" alt="">
                                    <div class="overlay-to-top">
                                        <p class="small margin-clear"><em>Web design <br> Lorem ipsum dolor sit</em></p>
                                    </div>
                                </div>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="image-box style-2 mb-20 shadow bordered light-gray-bg text-center">
                    <div class="overlay-container">
                        <img src="/resources/lib/bootstrap/html/template/images/portfolio-2.jpg" alt="">
                        <div class="overlay-to-top">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="image-box style-2 mb-20 shadow bordered light-gray-bg text-center">
                    <div class="overlay-container">
                        <img src="/resources/lib/bootstrap/html/template/images/portfolio-3.jpg" alt="">
                        <div class="overlay-to-top">
                            <p class="small margin-clear"><em>App development <br> Lorem ipsum dolor sit</em></p>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="image-box style-2 mb-20 shadow bordered light-gray-bg text-center">
                    <div class="overlay-container">
                        <img src="/resources/lib/bootstrap/html/template/images/portfolio-4.jpg" alt="">
                        <div class="overlay-to-top">
                            <p class="small margin-clear"><em>Web design <br> Lorem ipsum dolor sit</em></p>
                        </div>
                    </div>
        ...
        <div class="clients-container">
            <div class="clients">
                <div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="100">
                    <a href="#"><img src="/resources/lib/bootstrap/html/template/images/client-1.png" alt=""></a>
                </div>
                <div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="200">
                    <a href="#"><img src="/resources/lib/bootstrap/html/template/images/client-2.png" alt=""></a>
                </div>
                <div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="300">
                    <a href="#"><img src="/resources/lib/bootstrap/html/template/images/client-3.png" alt=""></a>
                </div>
                <div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="400">
                    <a href="#"><img src="/resources/lib/bootstrap/html/template/images/client-4.png" alt=""></a>
                </div>
                <div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="500">
                    <a href="#"><img src="/resources/lib/bootstrap/html/template/images/client-5.png" alt=""></a>
                </div>
                <div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="600">
                    <a href="#"><img src="/resources/lib/bootstrap/html/template/images/client-6.png" alt=""></a>
                </div>
                <div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="700">
                    <a href="#"><img src="/resources/lib/bootstrap/html/template/images/client-7.png" alt=""></a>
                </div>
                <div class="client-image object-non-visible" data-animation-effect="fadeIn" data-effect-delay="800">
                    <a href="#"><img src="/resources/lib/bootstrap/html/template/images/client-8.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="testimonial text-center">
                        <div class="testimonial-image">
                            <img src="/resources/lib/bootstrap/html/template/images/testimonial-1.jpg" alt="Jane Doe" title="Jane Doe" class="img-circle">
                        </div>
                        <h3>Just Perfect!</h3>
                        <div class="separator"></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="testimonial text-center">
                        <div class="testimonial-image">
                            <img src="/resources/lib/bootstrap/html/template/images/testimonial-2.jpg" alt="Jane Doe" title="Jane Doe" class="img-circle">
                        </div>
                        <h3>Amazing!</h3>
                        <div class="separator"></div>
                        <div class="testimonial-body">
