package com.seolgi.wedding.invitation.api.exceptionHandler;


import com.seolgi.wedding.invitation.api.WebApiApplication;
...
@ControllerAdvice (basePackageClasses = WebApiApplication.class)
