...
import com.seolgi.wedding.pc_web.config.helper.EqualsHelper;
import com.seolgi.wedding.pc_web.config.xss.XssModule;
import com.seolgi.wedding.pc_web.interceptor.commonCode.CommonCodeInterceptor;
import com.seolgi.wedding.pc_web.interceptor.user.LoggedUserInterceptor;
...
@Configuration
public class PcWebApplicationConfig extends WebMvcConfigurerAdapter {
